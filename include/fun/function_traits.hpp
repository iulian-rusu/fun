#ifndef FUNCTIONAL_FUNCTION_TRAITS_HPP
#define FUNCTIONAL_FUNCTION_TRAITS_HPP
...
namespace fun
{
     ...
     */
    template<typename T>
    using is_callable = is_callable_impl<std::decay_t<T>>;

    template<typename T>
    constexpr bool is_callable_v = is_callable<T>::value;

}
#endif //FUNCTIONAL_FUNCTION_TRAITS_HPP